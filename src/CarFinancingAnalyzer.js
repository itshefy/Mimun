  ...
  const carDatabase = {
    ...
    'ספורט': {
      'בנזין': [
        ...
        { name: 'אאודי R8', price: 900000, features: ['מנוע V10 עוצמתי', 'ביצועים על', 'עיצוב מרהיב', 'טכנולוגיה מתקדמת', 'איכות גרמנית'], description: 'אאודי R8 היא מכונית על עם מנוע V10 עוצמתי וביצועים מרשימים. היא מציגה עיצוב מרהיב, טכנולוגיה מתקדמת ואיכות גרמנית ידועה.' },
