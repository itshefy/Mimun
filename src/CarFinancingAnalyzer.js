...
const carDatabase = {
  'משפחתי': {
    ...
    'משומש': [
      ...
      { name: 'הונדה סיוויק', features: ['אמינות גבוהה', 'ביצועים טובים', 'איכות בנייה', 'ערך שוק גבוה', 'חסכונית'], description: 'הונדה סיוויק היאמכונית אמינה עם ביצועים מרשימים. איכות הבנייה הגבוהה שלה מבטיחה עמידות לאורך זמן, וערך השוק הגבוה שלה הופך אותה להשקעה טובה. בנוסף, היא חסכונית בדלק, מה שמוריד את עלויות התפעול.' },
  ...
  'חשמלי': {
    'חדש': [
      ...
      { name: 'שברולט בולט', features: ['טווח נסיעהארוך', 'מחיר תחרותי', 'ביצועים טובים', 'מרווח פנימי נדיב', 'טכנולוגיה מתקדמת'], description: 'שברולט בולט מציעה טווח נסיעה ארוך במיוחד במחיר תחרותי. היא מתהדרת בביצועים טובים ומרווח פנימי נדיב. הטכנולוגיה המתקדמת והערך הגבוה תמורת המחיר הופכים אותה לאפשרות אטרקטיבית בשוק הרכבים החשמליים.' },
    ...
    'משומש': [
      ...
      { name: 'מיצובישי i-MiEV', features: ['קומפקטי', 'קל לחניה', 'עלויות תפעול נמוכות', 'אמינות יפנית', 'מחיר נוח'], description: 'מיצובישי i-MiEV היא מכונית חשמלית קומפקטית וקלה לחניה. היא מציעה עלויות תפעול נמוכות ואמינות יפנית ידועה. המחיר הנוח בשוק המשומשות הופך אותה לאפשרות טובה למי שמחפש כניסה זולה לעולם הרכב החשמלי.' },
...
const generatePersonalizedClosing = (firstName, personalityTraits) => {
  const closings = [
    `לאור מה שדיברנו, אני חושב שיש לנו כאן כמה אפשרויות מעולות עבורך. מה דעתך שניפגש ונדבר עלזה יותר לעומק? אני בטוח שנוכל למצוא את הרכב המושלם שיתאים לאישיות הייחודית שלך.`,
